...
train_best='python train_model.py --trainingdata_dir data/final512data --eval_data_dir data/final512data --output_dir data/final512output --job-dir data/best_model_log --num_epochs 20 --batch_size 32 --learning_rate 0.001 --model_type cnn'
train_best_mlp='python train_model.py --trainingdata_dir data/final512data --eval_data_dir data/final512data --output_dir data/final512output --job-dir data/best_mlp_log --num_epochs 20 --batch_size 32 --learning_rate 0.001 --model_type mlp'
